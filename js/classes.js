...
class fighter extends sprite {
    ...
    switchSprite(sprite) {
        ...
        if(this.image === this.sprites.attack1.image && this.currentFrames<this.sprites.attack1.maxFrames - 1) return;
        if(this.image === this.sprites.takeHit.image && this.currentFrames<this.sprites.takeHit.maxFrames - 1) return;
        switch (sprite) {
            case 'idle':
